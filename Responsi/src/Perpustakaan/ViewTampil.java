...
public class ViewTampil extends JFrame {
    ...
    JLabel lTitle1 = new JLabel("Klik Tabel Terlebih Dahulu jika ingin Hapus/Edit");
    ...
    public ViewTampil() {
        ...
        lTitle.setBounds(150, 25, 100, 20);
        lTitle1.setBounds(60, 50, 300, 50);
